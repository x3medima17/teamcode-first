...
$.post("contest_check.php",{type:"add",title:title,start:start,end:end},function(data){
 if(data=='1'){
  $("#res").text("There are some errors");
 }
 else window.location='contests.php';
...
<h3><p style="color:#ccc">Add contest</p></h3>
<br>
<table class="std_table" >
  ...
  <tr>
    <td>Start time:</td><td><input type="text" id="start"> (YYYY-MM-DD HH:MM:SS)</td>
    </tr>
    <tr>
    <td>End time:</td><td><input type="text" id="end"> (YYYY-MM-DD HH:MM:SS)</td>
</tr>
<tr>
